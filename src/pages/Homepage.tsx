...
import { Bed, CalendarV2, Check, Login, Logout, XCircle } from "../assets/icons";
import { BarChart, Calendar } from "../components";
import { AlternativeCard, ImgHolder, MainCard, MenuContainer } from "../components/Styles";
		...
		<>
			<TopSection id="top-container">
				<div className="lil-card-container">
					<MainCard className="lil-card-container-card" width="auto" borderRadius="12px">
			...
			<MidSection id="mid-container">
				...
				<div id="mid-right-container" className="side-container">
					<MainCard className="side-container-top-card" borderRadius="16px">
						...
						>
							<h3 style={{ fontWeight: "400", fontSize: "19px" }}>Reservation stats</h3>
							<MenuContainer>
			...
			<BottomSection id="bottom-container">
				...
				<MainCard className="reviews" borderRadius="16px">
					...
					<div className="reviews--flex">
						...
						>
							<SwiperSlide>
								<AlternativeCard className="slider-container" borderRadius="16px">
