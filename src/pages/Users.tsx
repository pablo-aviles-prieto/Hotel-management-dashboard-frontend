...
const Users = () => {
	...
	useEffect(() => {
		...
		const arrayToRender = paginationDataHandler(filteredReorderedUsers, PAGINATION_OFFSET, page);
		...
		<>
			<MenuContainer style={{ marginBottom: "50px" }}>
				...
				<div id="buttons-container">
					...
					/>
					<InputSelect padding="13px 25px" positionArrowY="5px" onChange={inputSelectHandler}>
			...
			{statusAPI === "loading" ? (
				...
				<>
										...
										<td>
											<FlexContainer>
												...
												<div>
													...
													<StyledParagraph>Joined on {dateHandler(user.startDate)}</StyledParagraph>
												</div>
											</FlexContainer>
										</td>
					...
					<PaginationButtons style={{ margin: "50px 0" }}>
						<p>
							Showing {usersListSliced.length} of {filteredUsersList.length} Data
						</p>
