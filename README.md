...
Hotel Miranda dashboard to manage all the internal structure of the hotel. Getting the data from the [Hotel Miranda backend](https://github.com/Pablo-Aviles-Prieto/Hotel-management-dashboard-backend)
